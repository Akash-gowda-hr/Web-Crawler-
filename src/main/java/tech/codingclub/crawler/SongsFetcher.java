...
import tech.codingclub.fileutility.FileHandling;
...
public class SongsFetcher implements Runnable {
    ...
    public void run(){
        ...
        try {
            ...
            String songsResponseHTML = HttpUrlConnection.sendGet(link);
            ...
            for(String childLink : childLinks){
                ...
                try {
                    String childPageResponseHTML = HttpUrlConnection.sendGet(childLink);
                    ...
                    for (Element childElement : childElements) {
                        ...
                        new GenericDB<Song>().addRow(tech.codingclub.tables.Song.SONG, song);
...
//                        System.out.println(json);
    ...
    public static void main(String[] args) {
        String filePath = "C:\\Users\\akash\\IdeaProjects\\Song Crawler\\practise\\file\\java\\music.txt";
    ...
    private static ArrayList<String> readAllLinksFromFile(String filePath) {
        ArrayList<String> links = FileHandling.readFileAsList(filePath);
        return links;
    }
}
